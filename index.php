...
<body>
    ...
    <section>
        <div class="container">
            ...
            ?>
            <img class="title_img" src="img/01.jpg" alt="">
            <div class="section">
                <a class="category" href="#">
                    <img class="category_img" src="img/02.jpg" alt="">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/03.jpg" alt="">
                    <h4 class="category_title">
                        SPA Шоколад
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/04.jpg" alt="">
                    <h4 class="category_title">
                        SPA Белый лотос
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/05.jpeg" alt="">
                    <h4 class="category_title">
                        SPA Релаксация
                    </h4>
                    <p class="category_text">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/06.jpeg" alt="">
                    <h4 class="category_title">
                ...
                <a class="category" href="#">
                    <img class="category_img" src="img/07.jpg" alt="">
                    <h4 class="category_title">
                        SPA Роял Манго
                    </h4>
                    <p class="category_text">
